...
// packages/api/src/handlers/post-jobs.ts
var post_jobs_exports = {};
__export(post_jobs_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(post_jobs_exports);
var import_db = __toESM(require_dist());
var handler = async () => {
  const job = await import_db.prisma.job.create({ data: {} });
  return {
    statusCode: 201,
