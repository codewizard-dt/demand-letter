...
var get_jobs_template_zones_exports = {};
__export(get_jobs_template_zones_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_jobs_template_zones_exports);
...
var handler = async (event) => {
  ...
  const zones = await import_db.prisma.zone.findMany({
    where: { templateId },
