...
// packages/api/src/handlers/get-jobs.ts
var get_jobs_exports = {};
__export(get_jobs_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_jobs_exports);
var import_db = __toESM(require_dist());
var handler = async () => {
  const jobs = await import_db.prisma.job.findMany({
