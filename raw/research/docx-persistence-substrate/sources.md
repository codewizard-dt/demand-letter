...
| S3  | web      | https://docx.js.org/                                                                                                                       | 2026-06-22 | `docx` (dolanmiu) is a TS/JS library for _generating_ docx with zero runtime deps; declarative authoring, not an arbitrary-template fill engine                                                         |
