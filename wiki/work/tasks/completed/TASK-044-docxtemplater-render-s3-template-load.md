...
- [x] Run `pnpm --filter @demand-letter/api add docxtemplater pizzip`. <!-- Completed: 2026-06-25 — already present in package.json -->
- [x] Add `@types/pizzip` if available, otherwise use `// @ts-ignore` for the PizZip import. <!-- Completed: 2026-06-25 — @types/pizzip@3.1.2 installed; @ts-ignore kept on import -->

### 2. Create `packages/api/src/lib/docx-renderer.ts`  <!-- agent: general-purpose -->

- [x] Create the file: <!-- Completed: 2026-06-25 -->
  ```ts
  ...
  ```
- [x] Inside `renderTemplate`: <!-- Completed: 2026-06-25 — nullGetter signature fixed to (part) not ({part}) -->
...
- [x] Add: `export { renderTemplate, TemplateRenderError } from './docx-renderer';` <!-- Completed: 2026-06-25 -->

### 4. Typecheck  <!-- agent: general-purpose -->

- [x] Run `pnpm typecheck` from the repo root. <!-- Completed: 2026-06-25 — passes with zero errors -->
- [x] Fix any type errors (especially around PizZip types) before marking done. <!-- Completed: 2026-06-25 — fixed nullGetter param destructuring (part vs {part}) -->
