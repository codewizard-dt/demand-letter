...
| --- | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------- |
| 1   | Cover **both** PHI (HIPAA) and PII (SOC 2)       | Logs/store carry medical PHI _and_ attorney/client PII; SOC 2 covers all personal data, not just health             |
