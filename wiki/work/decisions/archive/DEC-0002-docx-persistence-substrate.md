...
| Cons | Programmatic *filling* in Node needs Aspose (commercial, .NET-bridged) or hand-rolled OOXML; loops/conditionals are manual node manipulation; no built-in slot-enumeration helper |
